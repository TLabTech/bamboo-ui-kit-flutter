...
class TButtonDestructive extends StatefulWidget {
  final String? text;
  ...
  @override
  State<TButtonDestructive> createState() => _TButtonDestructiveState();
}

class _TButtonDestructiveState extends State<TButtonDestructive> {
  ...
  Widget build(BuildContext context) {
      ...
      return GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: _isPressed
                ? (widget.onPressedBackgroundColor ?? theme.destructivePressed)
                : (widget.backgroundColor ?? theme.destructive),
    ...
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        backgroundColor: widget.backgroundColor ?? theme.destructive,
    ...
    Widget? leadingIcon = widget.loading
        ? SizedBox(
            ...
            child: CircularProgressIndicator(
              color: widget.loadingColor ?? theme.destructiveForeground,
            ),
          )
        : widget.prefixIcon;
